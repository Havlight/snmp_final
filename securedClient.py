...
def set_ClientStartIp(value, row=1):
    ...
    set_snmp(target, oid, value, rfc1902.IpAddress)
...
def set_ClientService(value, row=1):
    ...
    set_snmp(target, oid, value, rfc1902.Bits)
